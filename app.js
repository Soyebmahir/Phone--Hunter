...
const phoneDetails = (datas) => {
  ...
  <div class="card-body overflow-auto w-50">
    ...
    <p class="card-text ">Brand : ${datas.brand?datas.brand : 'Not availabe'} <br>Release Date: ${datas.releaseDate?datas.releaseDate:'Not Available'} <br><b class="text-info">Main Features:</b><br>ChipSet : ${dataMainFeature.chipSet?dataMainFeature.chipSet :'Not availabe'} <br> Display Size : ${dataMainFeature.displaySize}<br>Memory : ${dataMainFeature.memory} <br>Storage : ${dataMainFeature.storage?dataMainFeature.storage:'Not availabe'} <br><b class="text-info">Sensors :</b> <br> ${sensor?sensor:'Not availabe'}<br> <b class="text-info">Others :</b><br>Bluetooth : ${dataOthers.bluetooth?dataOthers.bluetooth:'Not Available'}<br>GPS : ${dataOthers.GPS? dataOthers.GPS : 'Not Available'}<br>NFC : ${dataOthers.NFC? dataOthers.NFC :'Not Available'}, Radio : ${dataOthers.Radio? dataOthers.Radio : 'Not Available'}<br>USB : ${dataOthers.USB?dataOthers.USB :'Not Available'}<br>WLAN : ${dataOthers.WLAN?dataOthers.WLAN :'Not Available'} </p>
  </div>
